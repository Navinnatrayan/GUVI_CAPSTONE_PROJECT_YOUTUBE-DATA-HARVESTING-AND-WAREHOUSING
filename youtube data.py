...
#API key connection
def Api_connect():
    Api_Id="AIzaSyAEY7eGSd5Oc2-Zr7gJy0tasuH2B0GF0CM"
...
client = pymongo.MongoClient("mongodb+srv://navin:kameshnavin@cluster0.a1w1kjz.mongodb.net/?retryWrites=true&w=majority")
...
show_table = st.radio("SELECT THE TABLE FOR VIEW",(":violet[CHANNELS]",":red[PLAYLISTS]",":green[VIDEOS]",":yellow[COMMENTS]"))
...
if question =="1. What are the names of all the videos and their corresponding channels?":
    ...
    st.write(df2)
        ...
        mydb.commit()
        t8=cursor.fetchall()
        df8=pd.DataFrame(t8,columns=["Video Title", "Video Publised On", "Channel Name"])
        st.write(df8)
